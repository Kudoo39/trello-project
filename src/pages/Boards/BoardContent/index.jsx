        ...
        >
          ...
          <Box
            sx={{
              ...
              '&::-webkit-scrollbar-thumb': { backgroundColor: '#ced0d2' },
        ...
        >
          ...
          >
            <Card sx={{ cursor: 'pointer', boxShadow: '0 1px 1px rgba(0,0,0,0.2)', overflow: 'unset' }}>
              <CardMedia
                sx={{ height: 140 }}
                image="https://raw.githubusercontent.com/Kudoo39/serenity-space/main/src/assets/city/day.png"
                title="green iguana"
              />
              <CardContent sx={{ 'p': 1.5, '&:last-child': { p: 1.5 } }}>
                <Typography>Serenity Space</Typography>
            ...
            <Card sx={{ cursor: 'pointer', boxShadow: '0 1px 1px rgba(0,0,0,0.2)', overflow: 'unset' }}>
              <CardContent sx={{ 'p': 1.5, '&:last-child': { p: 1.5 } }}>
                <Typography>Sunny Card</Typography>
              </CardContent>
            </Card>
          </Box>
